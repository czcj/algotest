...
public class AssessmentByPreAss {

	private static Logger logger = LoggerFactory.getLogger(AssessmentByPreAss.class);
	private volatile static AssessmentByPreAss assessment;
	public AssessmentByPreAss(){}

	/**
	 * 这种方式采用双锁机制，安全且在多线程情况下能保持高性能。
	 * @return
	 */
	public static AssessmentByPreAss getSingleton() {
		return new AssessmentByPreAss();
	}
